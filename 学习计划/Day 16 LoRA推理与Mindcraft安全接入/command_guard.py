...
# These are the commands and arguments represented in the current SFT dataset.
# Expanding capabilities requires adding a verified command here and corresponding data.
ALLOWED_COMMANDS = {
    "!stop",
    "!inventory",
    "!nearbyBlocks",
...
def validate_model_output(raw_output: str) -> GuardResult:
    """Return an executable command, approved text reply, or a blocked safe reply."""
